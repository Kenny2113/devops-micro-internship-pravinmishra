...
![Output of `git status` and `git branch`](screenshots/Ass3-01.png)
---
...
![Output of `git checkout -b feature/contact-page`](screenshots/Ass3-02.png)
---
...
![Output of `ls` showing `contact.html`](screenshots/Ass3-03.png)
---

#### Screenshot 4 — Output of `git commit`

![Output of `git commit`](screenshots/Ass3-04.png)
---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Output of `git log --oneline -3`](screenshots/Ass3-05.png)
---
...
![`git status` showing `index.html`](screenshots/Ass3-06.png)
---

#### Screenshot 7 — Output of `git commit`

![Output of `git commit`](screenshots/Ass3-07.png)
---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Browser showing the Contact Page link](screenshots/Ass3-08.png)
---
...
![checkout and `ls` output, proving `contact.html`](screenshots/Ass3-09.png)
---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Browser showing the homepage](screenshots/Ass3-10.png)
---
...
![Output of `git merge feature/contact-page`](screenshots/Ass3-11.png)
---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Output of `ls` showing `contact.html`](screenshots/Ass3-12.png)
---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Browser showing the Contact page](screenshots/Ass3-13.png)
---
...
![Full output of `git log --oneline --graph --decorate --all`](screenshots/Ass3-14.png)
---
...
![Output showing `feature/contact-page`](screenshots/Ass3-15.png)
---
