...
![VPC details showing CIDR 10.0.0.0/16](screenshots/Ass4-01.png)
---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Subnets list showing both subnets and their CIDRs](screenshots/Ass4-02.png)
---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Route table showing 0.0.0.0/0 → IGW](screenshots/Ass4-03.png)
---
...
![EC2 security-group inbound rules showing ports and sources](screenshots/Ass4-04.png)
---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![RDS security-group inbound rule](screenshots/Ass4-05.png)
---
...
![EC2 instance summary](screenshots/Ass4-06.png)
---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Terminal showing a successful SSH login](screenshots/Ass4-07.png)
---
...
![Output of `node -v` and `npm -v`](screenshots/Ass4-08.png)
---

#### Screenshot 9 — Output of `systemctl status nginx`

![Output of `systemctl status nginx`](screenshots/Ass4-09.png)
---

#### Screenshot 10 — Output of `mysql --version`

![Output of `mysql --version`](screenshots/Ass4-10.png)
---
...
![RDS instance summary](screenshots/Ass4-11.png)
---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Connectivity & security section](screenshots/Ass5-12.png)
---
...
![Terminal showing successful `SHOW TABLES;](screenshots/Ass5-13.png)
---
...
![`nginx -t` success output](screenshots/Ass5-17.png)
---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Nginx configuration snippet](screenshots/Ass5-18.png)
---
