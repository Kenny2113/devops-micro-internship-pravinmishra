...
![Terminal showing successful `terraform version` output](screenshots/Ass1-01.png)
---

#### Screenshot 2 — Terminal showing successful `az version` output

![Terminal showing successful `az version` output](screenshots/Ass1-02.png)
---

#### Screenshot 3 — VS Code Extensions panel showing the HashiCorp Terraform extension installed and enabled

![VS Code Extensions panel showing the HashiCorp Terraform](screenshots/Ass1-03.png)
---
...
![VS Code showing the AzureRM provider configuration](screenshots/Ass1-04.png)
---
...
![VS Code showing the AzureRM provider configuration](screenshots/Ass1-05.png)
...
![Terminal showing the successful `terraform init` output](screenshots/Ass1-06.png)
---
...
![Terraform plan summary showing the proposed resources](screenshots/Ass1-07.png)
---

#### Screenshot 8 — Terraform apply output showing successful completion

![Terraform apply output showing successful completion](screenshots/Ass1-08.png)
---

#### Screenshot 9 — Terraform output showing the public IP address of the VM

![Terraform output showing the public IP address of the VM](screenshots/Ass1-09.png)

### Question

VM Public IP Address: 20.215.67.250
...
![Azure CLI output showing the deployed VM name and `VM running`](screenshots/Ass1-10.png)
---
...
![Terminal showing successful `terraform destroy`](screenshots/Ass1-11.png)
---
