...
![Screenshot 1 — Output of `node -v && npm -v`](screenshots/Ass2-01.png)
...
![Screenshot 2 — Output of `systemctl status nginx --no-pager`](screenshots/Ass2-02.png)
...
![Screenshot 3 — Output of `ls` inside the `my-react-app`](screenshots/Ass2-03.png)
...
![Screenshot 4 — `nano App.js`](screenshots/Ass2-04.png)
---
...
![Screenshot 5 — Output of `ls` inside `my-react-app` ](screenshots/Ass2-05.png)
...
![Screenshot 6 — Output of `ls /var/www/html/`](screenshots/Ass2-06.png)
...
![Screenshot 7 — Output of `systemctl is-active nginx`](screenshots/Ass2-07.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Screenshot 8 — Output of `cat /etc/nginx/sites-available/default`](screenshots/Ass2-08.png)
...
![Screenshot 9 — Output of `curl ifconfig.me`](screenshots/Ass2-09.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Screenshot 10 — Browser showing the deployed React app](screenshots/Ass2-10.png)
...
https://www.linkedin.com/posts/kennedy-nwachukwu-601466170_dmibypravinmishra-devops-aws-ugcPost-7483813370723250176-tH2M/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACilgeEBgxwh_-W79kFyWdCZeNgA2BEfYRQ
---

#### Screenshot — LinkedIn post showing the deployed application

![Screenshot — LinkedIn post showing the deployed application](screenshots/Ass2-11.png)
---
